...
export VISUAL="emacsclient -t"         # $VISUAL opens in GUI with non-daemon as alternate
export TERM=xterm-256color           # this works with tmux and emacs 
#these lines are for npm
#export PATH="$PATH:$HOME/pkg/npm/bin"
#export NODE_PATH="$NODE_PATH:$HOME/pkg/npm/lib/node_modules"

# git stuff + PS1 ######################################

source /etc/bash_completion.d/git-prompt

# from http://stackoverflow.com/questions/17333531/how-can-i-display-the-current-branch-and-folder-path-in-terminal/38758377#38758377
...
export GIT_PS1_STATESEPARATOR=' '         # space between branch and index status
